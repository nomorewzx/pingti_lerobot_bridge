# Copy and modify from lerobot.robots.so100_follower.bi_so100_follower.py
...
from .config_bi_pingti_follower import BiPingtiFollowerConfig

logger = logging.getLogger(__name__)


class BiPingtiFollower(Robot):
    """
    [Bimanual Pingti Follower Arms](https://github.com/nomorewzx/PingTi-Arm)
    """

    config_class = BiPingtiFollowerConfig
    name = "bi_pingti_follower"

    def __init__(self, config: BiPingtiFollowerConfig):
        super().__init__(config)
        self.config = config

        left_arm_config = PingtiFollowerConfig(
        ...
        right_arm_config = PingtiFollowerConfig(
